...
import {
    ...
    calculateTotalResurrectTime,
    calculateTotalResurrects,
...
export const aggregateJSONLogs = (req: any, res: any) => {
    ...
    for (const [key, value] of Object.entries(players)) {
        strippedDownStats.push({
            ...
            playerResurrects: calculateTotalResurrects(value),
            playerResurrectTime: calculateTotalResurrectTime(value),
